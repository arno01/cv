...
📍 Prague, Czechia | 🇨🇿 Czech Citizen  
📧 andrey.arapov@nixaid.com | GitHub: [arno01](https://github.com/arno01), [andy108369](https://github.com/andy108369) | [Nostr](https://primal.net/p/npub1andyx2xqhwffeg595snk9a8ll43j6dvw5jzpljm5yjm3qync7peqzl8jd4)

---

## Senior DevOps & SRE Engineer | Linux Expert | Open Source Contributor

**17+ years** building and scaling secure, high-performance Linux/UNIX infrastructures for enterprise, blockchain, and cloud-native environments. Proven track record in **automation, container orchestration, GPU cluster administration, and performance tuning**. Contributor to multiple high-impact open-source projects including the Linux kernel, Qubes OS, NixOS, and Kubernetes.
...
### Overclock Labs / Akash Network — Senior DevOps & SRE Engineer
*Prague, Czechia | Apr 2022 – Jul 2025*  
